...
store i32 0, i32* %1
  ...
  call void @.vectorAssign(%struct.vector* %y, %struct.vector* %_9)


  ; load vector
   %_10 = alloca %struct.vector, align 8
   call void @.vectorAssign(%struct.vector* %_10, %struct.vector* %x)
  ; nop
  %10 = add i1 0, 0
  ; load vector
   %_11 = alloca %struct.vector, align 8
   call void @.vectorAssign(%struct.vector* %_11, %struct.vector* %y)
  ; nop
  %11 = add i1 0, 0

  %_12 = alloca %struct.vector, align 8
  call void @.vectorAdd(%struct.vector* %_10, %struct.vector* %_11, %struct.vector* %_12)
